...
class HistogramEventProto_Bucket : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:metrics.HistogramEventProto.Bucket) */ {
 public:
  ...
  void Swap(HistogramEventProto_Bucket* other);
  ...
  inline HistogramEventProto_Bucket* New() const PROTOBUF_FINAL { return New(NULL); }

  HistogramEventProto_Bucket* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class HistogramEventProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:metrics.HistogramEventProto) */ {
 public:
  HistogramEventProto();
  ...
  void Swap(HistogramEventProto* other);
  ...
  inline HistogramEventProto* New() const PROTOBUF_FINAL { return New(NULL); }

  HistogramEventProto* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
