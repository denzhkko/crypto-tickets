...
class PerfStatProto_PerfStatLine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:metrics.PerfStatProto.PerfStatLine) */ {
 public:
  ...
  void Swap(PerfStatProto_PerfStatLine* other);
  ...
  inline PerfStatProto_PerfStatLine* New() const PROTOBUF_FINAL { return New(NULL); }

  PerfStatProto_PerfStatLine* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class PerfStatProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:metrics.PerfStatProto) */ {
 public:
  PerfStatProto();
  ...
  inline PerfStatProto* New() const PROTOBUF_FINAL { return New(NULL); }

  PerfStatProto* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
