...
#ifndef PROTOBUF_printer_5fevent_2eproto__INCLUDED
#define PROTOBUF_printer_5fevent_2eproto__INCLUDED
...
inline const ::std::string& PrinterEventProto_EventType_Name(PrinterEventProto_EventType value) {
  return ::google::protobuf::internal::NameOfEnum(
    PrinterEventProto_EventType_descriptor(), value);
}
inline bool PrinterEventProto_EventType_Parse(
    const ::std::string& name, PrinterEventProto_EventType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PrinterEventProto_EventType>(
    PrinterEventProto_EventType_descriptor(), name, value);
}
// ===================================================================

class PrinterEventProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:metrics.PrinterEventProto) */ {
 public:
  PrinterEventProto();
  ...
  void Swap(PrinterEventProto* other);
  ...
  inline PrinterEventProto* New() const PROTOBUF_FINAL { return New(NULL); }

  PrinterEventProto* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  EventType_descriptor() {
    return PrinterEventProto_EventType_descriptor();
  }
  static inline const ::std::string& EventType_Name(EventType value) {
    return PrinterEventProto_EventType_Name(value);
  }
...
template <> struct is_proto_enum< ::metrics::PrinterEventProto_EventType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::metrics::PrinterEventProto_EventType>() {
  return ::metrics::PrinterEventProto_EventType_descriptor();
}
...
#endif  // PROTOBUF_printer_5fevent_2eproto__INCLUDED
