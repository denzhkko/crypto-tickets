...
class UserActionEventProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:metrics.UserActionEventProto) */ {
 public:
  ...
  void Swap(UserActionEventProto* other);
